...
import 'baseflow_plugin_template.dart';
...
class PermissionHandlerWidget extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _PermissionHandlerWidgetState();
}
...
/// Permission widget containing informatiion about the passed [Permission]
class PermissionWidget extends StatefulWidget {
  /// Constructs a [PermissionWidget] for the supplied [Permission]
  final Permission permission;

  const PermissionWidget({Key? key, required this.permission})
      : super(key: key);
